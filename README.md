...
| `extensions/pi-iterm2` | 扩展：pi-iterm2    | iTerm2 集成：标题显示提问、完成通知、等待提醒 |
...
- 安装某个扩展：`pi install <扩展本地路径>`，如 `pi install ***REMOVED***pi-packages/extensions/pi-iterm2`，详见各子目录的 README。
